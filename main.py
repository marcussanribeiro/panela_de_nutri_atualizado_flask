...
app.config['MAIL_USERNAME'] = 'evert.mitchell@ethereal.email'
app.config['MAIL_PASSWORD'] = 'JqsB6UvDFtpU3jHuYy'
app.config['MAIL_DEFAULT_SENDER'] = 'tickets@odygamers.p.tawk.email'
mail = Mail(app)
...
if __name__ == "__main__":
    app.run(debug=True, host="192.168.1.104", port="5084")